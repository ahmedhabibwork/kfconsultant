                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Careers List</span></h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">Careers</a>
                                </li>
                                <li class="breadcrumb-item active">Careers List
                                </li>
                            </ol>
                        </div>
                                ...
                                <div class="row">
                                    <form>
                                        ...
                                        <div class="col s12 m6 l3 display-flex align-items-center show-btn">
                                            ...
                                            <a href="{{ route('dashboard.careers.create') }}"
                                                class="mb-6 btn waves-effect waves-light red accent-2">Create Career</a>
                                    ...
                                    <div class="responsive-table">
                                                    ...
                                                    @foreach ($careers as $value)
                                                        ...
                                                        @endisset
                                                            ...
                                                            <td>
                                                                ...
                                                                <a
                                                                    href="{{ route('dashboard.careers.edit', $value->id) }}"><i
                                                            ...
                                                            <td>
                                                                ...
                                                                <a
                                                                    href="{{ route('dashboard.delete-career', $value->id) }}"><i
                                        ...
                                        @if ($careers->hasPages())
                                            <ul class="pagination" style="text-align:right">
                                                ...
                                                @else
                                                    <li class="waves-effect"><a href="{{ $careers->previousPageUrl() }}"
                                                            rel="prev">«prev</a></li>
                                                @endif

                                                @if ($careers->currentPage() > 3)
                                                    <li class="hidden-xs waves-effect"><a
                                                            href="{{ $careers->url(1) }}">1</a></li>
                                                @endif
                                                @if ($careers->currentPage() > 4)
                                                    <li class="waves-effect"><span>...</span></li>
                                                @endif
                                                @foreach (range(1, $careers->lastPage()) as $i)
                                                    @if ($i >= $careers->currentPage() - 2 && $i <= $careers->currentPage() + 2)
                                                        ...
                                                        @else
                                                            <li class="waves-effect"><a
                                                                    href="{{ $careers->url($i) }}">{{ $i }}</a>
                                                            </li>
                                                        @endif
                                                    @endif
                                                @endforeach
                                                @if ($careers->currentPage() < $careers->lastPage() - 3)
                                                    <li class="waves-effect"><span>...</span></li>
                                                @endif
                                                @if ($careers->currentPage() < $careers->lastPage() - 2)
                                                    <li class="hidden-xs waves-effect"><a
                                                            href="{{ $careers->url($careers->lastPage()) }}">{{ $careers->lastPage() }}</a>
                                                    </li>
                                                @endif

                                                {{-- Next Page Link --}}
                                                @if ($careers->hasMorePages())
                                                    <li class="waves-effect"> <a href="{{ $careers->nextPageUrl() }}"
                                                            rel="next">Next»</a></li>
                                                @else
