                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Categories List</span></h5>
                                    ...
                                    <form>
                                        ...
                                        <div class="col s12 m6 l3 display-flex align-items-center show-btn">
                                            ...
                                            <a href="{{ route('dashboard.categories.create') }}"
                                                class="mb-6 btn waves-effect waves-light red accent-2">Create Category</a>
                                    ...
                                    <div class="responsive-table">
                                                    ...
                                                    @foreach ($categories as $value)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a
                                                                    href="{{ route('dashboard.categories.edit', $value->id) }}"><i
                                                            ...
                                                            <td>
                                                                ...
                                                                <a
                                                                    href="{{ route('dashboard.delete-category', $value->id) }}"><i
                                        ...
                                        @if ($categories->hasPages())
                                            <ul class="pagination" style="text-align:right">
                                                ...
                                                @else
                                                    <li class="waves-effect"><a href="{{ $categories->previousPageUrl() }}"
                                                            rel="prev">«prev</a></li>
                                                @endif

                                                @if ($categories->currentPage() > 3)
                                                    <li class="hidden-xs waves-effect"><a
                                                            href="{{ $categories->url(1) }}">1</a></li>
                                                @endif
                                                ...
                                                @if ($categories->hasMorePages())
                                                    <li class="waves-effect"> <a href="{{ $categories->nextPageUrl() }}"
                                                            rel="next">Next»</a></li>
                                                @else
...
@section('java_script')
    ...
    <script type="text/javascript">
        function toggleStatus(id) {
            ...
            $.ajax({
                url: 'categories/change_status/' + id,
                type: "GET",
