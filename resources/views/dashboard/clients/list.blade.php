                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>clients List</span></h5>
                                    ...
                                    <form>
                                        ...
                                        <div class="col s12 m6 l3 display-flex align-items-center show-btn">
                                            ...
                                            <a href="{{ route('dashboard.clients.create') }}"
                                                class="mb-6 btn waves-effect waves-light red accent-2">Create Client</a>
                                    ...
                                    <div class="responsive-table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> @isset($value->link)
                                                                ...
                                                                <td> 
                                                                    ...
                                                                    <img src="{{ asset("/app-assets/images/Client/".$value->image) }}"
                                                            ...
                                                            <td>
                                                                ...
                                                                <a
                                                                    href="{{ route('dashboard.clients.edit', $value->id) }}"><i
                                                            ...
                                                            <td>
                                                                ...
                                                                <a
                                                                    href="{{ route('dashboard.delete-client', $value->id) }}"><i
                                        ...
                                        @if ($clients->hasPages())
                                            <ul class="pagination" style="text-align:right">
                                                ...
                                                @else
                                                    <li class="waves-effect"><a href="{{ $clients->previousPageUrl() }}"
                                                            rel="prev">«prev</a></li>
                                                @endif

                                                @if ($clients->currentPage() > 3)
                                                    <li class="hidden-xs waves-effect"><a
                                                            href="{{ $clients->url(1) }}">1</a></li>
                                                @endif
                                                @if ($clients->currentPage() > 4)
                                                    <li class="waves-effect"><span>...</span></li>
                                                @endif
                                                @foreach (range(1, $clients->lastPage()) as $i)
                                                    @if ($i >= $clients->currentPage() - 2 && $i <= $clients->currentPage() + 2)
                                                ...
                                                @if ($clients->hasMorePages())
                                                    <li class="waves-effect"> <a href="{{ $clients->nextPageUrl() }}"
                                                            rel="next">Next»</a></li>
                                                @else
