            ...
            <div class="section">
              <div id="card-stats" class="pt-0">
                <div class="row">
                    ...
                    <a href="{{ route('dashboard.projects.index') }}">
                      <div class="card animate fadeLeft">
                         <div class="card-content cyan white-text">
                            <p class="card-stats-title"><i class="material-icons">add_shopping_cart</i> Projects </p>
                            <h4 class="card-stats-number white-text">@isset($projectCount){!! $projectCount!!}@endisset projects</h4>
                         </div>
                   ...
                   <div class="col s12 m6 l2">
                      <div class="card animate fadeLeft">
                         <div class="card-content red accent-2 white-text">
                            <p class="card-stats-title"><i class="material-icons">attach_money</i> News</p>
                            <h4 class="card-stats-number white-text">@isset($newsCount){!! $newsCount!!} @endisset</h4>
                         </div>
                   ...
                   <div class="col s12 m6 l2">
                      <div class="card animate fadeRight">
                         <div class="card-content orange lighten-1 white-text">
                            <p class="card-stats-title"><i class="material-icons">trending_up</i> Categories </p>
                            <h4 class="card-stats-number white-text">@isset($categoryCount){!! $categoryCount!!} @endisset</h4>
                   ...
                   <div class="col s12 m6 l2">
                    <div class="card animate fadeRight">
                       <div class="card-content  lighten-1 white-text"  style="background:#467893">
                          <p class="card-stats-title"><i class="material-icons">trending_up</i>  Clients</p>
                          <h4 class="card-stats-number white-text">@isset($clientCount){!! $clientCount!!} @endisset</h4>
                   ...
                   <div class="col s12 m6 l2">
                      <div class="card animate fadeRight">
                         <div class="card-content green lighten-1 white-text">
                            <p class="card-stats-title"><i class="material-icons">trending_up</i> Careers</p>
                            <h4 class="card-stats-number white-text">@isset($careersCount){!! $careersCount!!} @endisset</h4>
                   ...
                   <div class="col s12 m6 l2">
                    <a href="{{ route('dashboard.contact-us.index') }}">
                      <div class="card animate fadeLeft">
                         <div class="card-content cyan white-text">
                            <p class="card-stats-title"><i class="material-icons">add_shopping_cart</i>Contact Us </p>
                            <h4 class="card-stats-number white-text">@if(isset($contactusCount)&&!empty($contactusCount)) {!!  $contactusCount !!}@else 0  @endif Contact</h4>
                         </div>
                  ...
                  <div class="row">
                     <div class="col s12">
                        <div class="yearly-revenue-chart"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                           <canvas id="thisYearRevenue" class="firstShadow chartjs-render-monitor" height="350" style="display: block; width: 626px; height: 350px;" width="626"></canvas>
                           <canvas id="lastYearRevenue" height="350" width="626" style="display: block; width: 626px; height: 350px;" class="chartjs-render-monitor"></canvas>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="col s12 m4 l4">
            <div id="weekly-earning" class="card animate fadeUp">
               <div class="card-content"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  ...
                  <canvas id="monthlyEarning" class="chartjs-render-monitor" height="150" width="277" style="display: block;"></canvas>
      ...
      <div class="row">
         <div class="col s12 m4 l4">
            <div class="card pt-0 pb-0 animate fadeLeft">
               ...
               <div class="sample-chart-wrapper" style="margin-bottom: -14px; margin-top: -75px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  <canvas id="custom-line-chart-sample-one" class="center chartjs-render-monitor" width="325" height="162" style="display: block; width: 325px; height: 162px;"></canvas>
               </div>
            </div>
         </div>
         <div class="col s12 m4 l4 animate fadeUp">
            <div class="card pt-0 pb-0">
               ...
               <div class="sample-chart-wrapper" style="margin-bottom: -14px; margin-top: -75px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  <canvas id="custom-line-chart-sample-two" class="center chartjs-render-monitor" width="325" height="162" style="display: block; width: 325px; height: 162px;"></canvas>
               </div>
            </div>
         </div>
         <div class="col s12 m4 l4">
            <div class="card pt-0 pb-0 animate fadeRight">
               ...
               <div class="sample-chart-wrapper" style="margin-bottom: -14px; margin-top: -75px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  <canvas id="custom-line-chart-sample-three" class="center chartjs-render-monitor" width="325" height="162" style="display: block; width: 325px; height: 162px;"></canvas>
               </div>
            </div>
         </div>
      </div>
...
<aside id="right-sidebar-nav">
  <div id="slide-out-right" class="slide-out-right-sidenav sidenav rightside-navigation right-aligned">
    <div class="row">
      ...
      <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 625px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 309px;"></div></div></div>
    </div>
  </div>
  ...
  <ul id="slide-out-chat" class="sidenav slide-out-right-sidenav-chat right-aligned">
    ...
    <li class="chat-body">
      ...
      <div class="ps__rail-x" style="left: 0px; bottom: -734px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 734px; height: 494px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 296px; height: 198px;"></div></div></ul>
    </li>
