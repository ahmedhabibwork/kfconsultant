                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>client</span></h5>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col s12">
                                                ...
                                                <form class="login-row" method="post" enctype="multipart/form-data"
                                                    action="{{ route('dashboard.news.update', $edit->id) }}">
                                                    @csrf
                                                                ...
                                                                @if (isset($edit->image))
                                                                    <div class="card animate fadeLeft">
                                                                        <div class="card-content">
                                                                            <p> Image </p>
                                                                            <img id="image"
                                                                                src="{{ asset("/app-assets/images/News/$edit->image") }}"
                                                                                alt="NO Upload Image "
                                                                                style=" height:160px;">
                                                        ...
                                                        <div class="row">
                                                            <div class="input-field col s6">
                                                                ...
                                                                <input id="publish_date"
                                                                    @error('publish_date') is-invalid @enderror
                                                                    type="text" class="datepicker mr-2 mb-1"
                                                                    name="publish_date" value="{{ $edit->publish_date }}">
