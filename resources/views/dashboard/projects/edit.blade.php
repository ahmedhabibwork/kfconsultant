                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col s12">
                                                ...
                                                <form class="login-row" method="post" enctype="multipart/form-data"
                                                    id="img-upload-form"
                                                    action="{{ route('dashboard.projects.update', $edit->id) }}">
                                                    @csrf
                                                    ...
                                                    <div class="col s12">
                                                                    ...
                                                                    @isset($categories)
                                                                        @foreach ($categories as $value)
                                                                            <option value="{{ $value->id }}"
                                                                                @if ($value->id == $edit->category_id) selected @endif
                                                                ...
                                                                <select class="select2 browser-default"
                                                                    ...
                                                                    @isset($scopes)
                                                                        @foreach ($scopes as $value)
                                                                            <option value="{{ $value->id }}"
                                                                                @if ($value->id == $edit->scope_id) selected @endif
                                                                                class="circle">{{ $value->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    @endisset
                                                                ...
                                                                <select class="select2 browser-default"
                                                                    ...
                                                                    @isset($scales)
                                                                        @foreach ($scales as $value)
                                                                            <option value="{{ $value->id }}"
                                                                                @if ($value->id == $edit->scale_id) selected @endif
                                                                                class="circle">{{ $value->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    @endisset
                                                                ...
                                                                <select class="select2 browser-default"
                                                                    ...
                                                                    @isset($status)
                                                                        @foreach ($status as $value)
                                                                            <option value="{{ $value->id }}"
                                                                                @if ($value->id == $edit->status_id) selected @endif
                                                                                class="circle">{{ $value->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    @endisset
                                                                ...
                                                                <select class="select2 browser-default"
                                                                    ...
                                                                    @isset($years)
                                                                        @foreach ($years as $value)
                                                                            <option value="{{ $value->id }}"
                                                                                @if ($value->id == $edit->year_id) selected @endif
                                                                                class="circle">{{ $value->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    @endisset
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="row">
                                                                @if (!empty($edit->getprojectImages))
                                                                    @foreach ($edit->getprojectImages as $value)
                                                                        <div class="col s12 m3 l3">
                                                                            <div class="card animate fadeLeft">
                                                                                <div class="card-content">

                                                                                    <img src="{{ asset('/app-assets/images/Project/' . $value->image) }}"
                                                                                        alt="img"
                                                                                        style=" height:160px;vertical-align: middle;">
                                                                                    <div
                                                                                        class="display-flex flex-wrap justify-content-center">
                                                                                        <a href="{{ asset('/app-assets/images/Project/' . $value->image) }}"
                                                                                            class="invoice-action-view mr-4">
                                                                                            <i
                                                                                                class="material-icons">remove_red_eye</i>
                                                                                        </a>
                                                                                        <a href="{{ route('dashboard.projects.delete_image', $value->id) }}"
                                                                                            class="invoice-action-view mr-4">
                                                                                            <i
