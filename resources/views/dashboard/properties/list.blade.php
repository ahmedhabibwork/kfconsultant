                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>@isset($title) {{ $title }} @endisset List </span></h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">@isset($title) {{ $title }} @endisset</a>
                                </li>
                                <li class="breadcrumb-item active">@isset($title) {{ $title }} @endisset List
                                </li>
                            </ol>
                        </div>
                                ...
                                <div class="row">
                                    <form>
                                        ...
                                        <div class="col s12 m6 l3 display-flex align-items-center show-btn">
                                                ...
                                                <a href="{{ route('dashboard.'.$routeName.'.create') }}"
                                                    class="mb-6 btn waves-effect waves-light red accent-2">Create @isset($title) {{ $title }} @endisset</a>
                                    ...
                                    <div class="responsive-table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <td>
                                                                  ...
                                                                  <a
                                                                        href="{{ route('dashboard.'.$routeName.'.edit', $value->id) }}"><i
                                                                ...
                                                                <td>
                                                                  ...
                                                                  <a
                                                                        href="{{ route('dashboard.delete-'.$routeName, $value->id) }}"><i
                                        ...
                                        @if ($properties->hasPages())
                                            <ul class="pagination" style="text-align:right">
                                                ...
                                                @else
                                                    <li class="waves-effect"><a href="{{ $properties->previousPageUrl() }}"
                                                            rel="prev">«prev</a></li>
                                                @endif

                                                @if ($properties->currentPage() > 3)
                                                    <li class="hidden-xs waves-effect"><a
                                                            href="{{ $properties->url(1) }}">1</a></li>
                                                @endif
                                                ...
                                                @if ($properties->currentPage() < $properties->lastPage() - 2)
                                                    <li class="hidden-xs waves-effect"><a
                                                            href="{{ $properties->url($properties->lastPage()) }}">{{ $properties->lastPage() }}</a>
                                                    </li>
                                                @endif

                                                {{-- Next Page Link --}}
                                                @if ($properties->hasMorePages())
                                                    <li class="waves-effect"> <a href="{{ $properties->nextPageUrl() }}"
                                                            rel="next">Next»</a></li>
                                                @else
...
@section('java_script')
    ...
    <script type="text/javascript">
        function toggleStatus(id) {
            $.ajax({
                url:  '<?php echo $routeName; ?>/change_status/' + id,
                type: "GET",
