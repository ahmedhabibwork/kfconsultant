                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item active">Create Sub Service
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col s12">
                                                ...
                                                <form class="login-row" method="post" enctype="multipart/form-data"
                                                    action="{{ route('dashboard.sub-services.store') }}">
                                                    @csrf

                                                    <div class="col s12">
                                                        <div class="row">
                                                        <div class="input-field col s6 m6">
                                                            <select class="select2 browser-default" @error('service_id') is-invalid @enderror
